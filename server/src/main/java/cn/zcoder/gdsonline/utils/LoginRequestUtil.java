...
public class LoginRequestUtil {
    ...
    public Code2SessionDto getCode2Session(String jsCode){
        ...
        return JSON.parseObject(restTemplate.getForObject(url, String.class, uriVariables), Code2SessionDto.class);
    }
}
